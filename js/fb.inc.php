...
/* small */
	...
	.fb_share_small .fb_sharebutton { 
		...
		text-align:left;
		border:1px solid #d8dfea;
		background:url('../img/fb_sq_small.png') no-repeat top right;
		background-color: #fff;
	}
...
<script> 
function share() {
	window.open('http://www.facebook.com/sharer.php?u=http://localhost/QWEJQ/page.php?id=10&t=','sharer','toolbar=0,status=0,width=626,height=436');
	return false;			
}
</script> 
</head> 
